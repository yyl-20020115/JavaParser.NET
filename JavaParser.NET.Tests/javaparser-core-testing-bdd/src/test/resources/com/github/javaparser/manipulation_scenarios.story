Scenario: A Node can only ever be equal to a class that:Node
...
Then Statement 1 _in BlockStmt toString is "return x + y;"
...
When a public static method called "main" returning void is added to class 1 _in the compilation unit
When string varargs called "args" are added to method 1 _in class 1
When a BlockStmt is added to method 1 _in class 1
When System._out.println("Hello World!"); is added to the body of method 1 _in class 1
Then the expected source should be:
namespace japa.parser.ast.manipulation;

public class CreateClass {

    public static void main(String... args) {
        System._out.println("Hello World!");
    }
}
...
When method 1 _in class 1 has it's name converted to uppercase
Then method 1 _in class 1 has the name "CHANGETOUPPERCASE"
...
Then method 1 _in class 1 has the name "CHANGETOUPPERCASE"
Then method 2 _in class 1 has the name "ANOTHERMETHODTOCHANGE"
...
When method 2 _in class 1 has an int parameter called "value" added
Then method 1 _in class 1 has 1 parameters
Then method 2 _in class 1 has 1 parameter
Then method 2 _in class 1 parameter 1 is type int called "value"
...
Then method 1 _in class 1 has 2 parameters
Then method 2 _in class 1 has 1 parameter
Then method 1 _in class 1 parameter 2 is type int called "value"
Then method 2 _in class 1 parameter 1 is type int called "value"
...
Then method 1 _in class 1 has the name "changeToUpperCase"
Then method 1 _in class 1 has 1 parameters
Then method 2 _in class 1 has 0 parameter