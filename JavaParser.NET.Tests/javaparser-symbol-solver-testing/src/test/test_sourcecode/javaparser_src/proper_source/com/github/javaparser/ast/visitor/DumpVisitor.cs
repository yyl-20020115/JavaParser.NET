...
public /*final*/class DumpVisitor implements VoidVisitor<Object> {
    ...
    private void printOrphanCommentsBeforeThisChildNode(/*final*/Node node){
        ...
        for (int i=positionOfPreviousChild+1;i<positionOfTheChild;i++){
            ...
            if (!(nodeToPrint is Comment)) throw new RuntimeException("Expected comment, instead "+nodeToPrint.getClass()+". Position of previous child: "+positionOfPreviousChild+", position of child "+positionOfTheChild);
