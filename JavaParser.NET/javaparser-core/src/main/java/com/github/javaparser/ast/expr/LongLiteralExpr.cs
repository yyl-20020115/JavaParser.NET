...
public class LongLiteralExpr:LiteralStringValueExpr {
    ...
    /**
     * @deprecated This function is deprecated _in favor of {@link #LongLiteralExpr(String)}. Please refer to the {@link
     ...
     * LongLiteralExpr#asNumber()}. It will be made private or merged with {@link LongLiteralExpr#asNumber()} _in future
     * releases
     */
    //@Deprecated
    public long asLong() {
     ...
     * case when the literal has the value {@code 9223372036854775808L}. This special literal is only allowed _in
     * the expression {@code -9223372036854775808L} which represents <code>Long.MIN_VALUE</code>). However
     * 9223372036854775808 (2^63) is _out of range of long, which is -(2^63) to (2^63)-1 and thus a BigInteger must be
     * returned.
     *
    ...
    public Number asNumber() {
         ...
         * LongLiteralExpr. However 9223372036854775808L cannot be represented _in a long, so we need
