 ...
 */
public class CatchClause:Node implements NodeWithBlockStmt<CatchClause> {
     ...
     * catch(@X A a |...) are found directly _in the Parameter. Annotations that are on the second or later type -
