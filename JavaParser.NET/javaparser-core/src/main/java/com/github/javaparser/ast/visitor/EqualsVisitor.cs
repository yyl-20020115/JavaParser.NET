...
public class EqualsVisitor implements GenericVisitor<Boolean, Visitable> {
    ...
    private <T:Node> boolean nodesEquals(/*final*/List<T> nodes1, /*final*/List<T> nodes2) {
        if (nodes1 == null) {
            return nodes2 == null;
        } else if (nodes2 == null) {
            return false;
    ...
    private <N:Node> boolean nodesEquals(NodeList<N> n, NodeList<N> n2) {
        if (n == n2) {
            return true;
        }
        if (n == null || n2 == null) {
    ...
    private <T:Node> boolean nodeEquals(/*final*/T n, /*final*/T n2) {
        if (n == n2) {
            return true;
        }
        if (n == null || n2 == null) {
    ...
    private <T:Node> boolean nodeEquals(/*final*/Optional<T> n, /*final*/Optional<T> n2) {
        return nodeEquals(n.orElse(null), n2.orElse(null));
    }

    private <T:Node> boolean nodesEquals(/*final*/Optional<NodeList<T>> n, /*final*/Optional<NodeList<T>> n2) {
