...
public class EqualsVisitor implements GenericVisitor<Boolean, Visitable> {
    ...
    public static bool equals(/*final*/Node n, /*final*/Node n2) {
     ...
     * to not repeat it _in every method we store that here.
     */
    ...
    private <T:Node> bool nodesEquals(/*final*/List<T> nodes1, /*final*/List<T> nodes2) {
        if (nodes1 == null) {
            return nodes2 == null;
        } else if (nodes2 == null) {
            return false;
    ...
    private <N:Node> bool nodesEquals(NodeList<N> n, NodeList<N> n2) {
        if (n == n2) {
            return true;
        }
        if (n == null || n2 == null) {
    ...
    private <T:Node> bool nodeEquals(/*final*/T n, /*final*/T n2) {
        if (n == n2) {
            return true;
        }
        if (n == null || n2 == null) {
    ...
    private <T:Node> bool nodeEquals(/*final*/Optional<T> n, /*final*/Optional<T> n2) {
        return nodeEquals(n.orElse(null), n2.orElse(null));
    }

    private <T:Node> bool nodesEquals(/*final*/Optional<NodeList<T>> n, /*final*/Optional<NodeList<T>> n2) {
        return nodesEquals(n.orElse(null), n2.orElse(null));
    }

    private bool objEquals(/*final*/Object n, /*final*/Object n2) {
        if (n == n2) {
            return true;
        }
        if (n == null || n2 == null) {
